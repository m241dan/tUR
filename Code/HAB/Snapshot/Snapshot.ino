...
//SoftwareSerial cameraconnection = SoftwareSerial(14, 15);
// On Mega: camera TX connected to pin 69 (A15), camera RX to pin 3:
SoftwareSerial cameraconnection = SoftwareSerial(A8, A9);
#else
NewSoftSerial cameraconnection = NewSoftSerial(14, 15);
#endif
