...
typedef struct sensor_readings
{
   ...
   unsigned char so2_reading[12];
   unsigned char no2_reading[12];
   unsigned char o3_reading[12];
   ...
   unsigned char pump_status[13];
   unsigned char bme_status[5];
   unsigned char am2315_status[5];
