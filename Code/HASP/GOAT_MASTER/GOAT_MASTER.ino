...
state state_machine[MAX_STATE] = { 
                                   receive_ground( ground_command_handle, readings.gtp, Serial, buffers.ground, buffers.ground_index ),
                                   receive_slave( readings.slave, Serial1, buffers.slave, buffers.slave_index ),
                                   downlink_ground( readings, sample_set, statuss, timers, Serial, blu_serial ),
