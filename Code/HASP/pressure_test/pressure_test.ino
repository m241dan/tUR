...
//Sample Rate
#define SAMPLE_RATE 100 		//In Hz, this basically just sets our delay between readings
...
void loop()
{
   delay( SAMPLE_RATE );    //Delaying basically one second because I don't want to overflow the SD and the BME usually needs a bit of additional time to "warm" up
