...
return {
    ...
    [3] = { x = 23.9, y = -5.1, z = 20.7, eeo = 0, velocity = 5, type = DISCRETE_W, precision = .5, shape = "linear", smoothness = 2, tolerance = 2 },
    [4] = { x = 22.00, y =-5.00, z = 20.7, eeo = 0, velocity = 5, type = DISCRETE_W, precision = .5, shape = "linear", smoothness = 2, tolerance = 2 },
}