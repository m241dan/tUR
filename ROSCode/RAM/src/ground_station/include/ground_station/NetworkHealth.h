// Generated by gencpp from file ground_station/NetworkHealth.msg
// DO NOT EDIT!


#ifndef GROUND_STATION_MESSAGE_NETWORKHEALTH_H
#define GROUND_STATION_MESSAGE_NETWORKHEALTH_H
...
struct NetworkHealth_
{
  ...
  typedef boost::shared_ptr< ::ground_station::NetworkHealth_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ground_station::NetworkHealth_<ContainerAllocator> const> ConstPtr;

}; // struct NetworkHealth_

typedef ::ground_station::NetworkHealth_<std::allocator<void> > NetworkHealth;

typedef boost::shared_ptr< ::ground_station::NetworkHealth > NetworkHealthPtr;
typedef boost::shared_ptr< ::ground_station::NetworkHealth const> NetworkHealthConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ground_station::NetworkHealth_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ground_station::NetworkHealth_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ground_station::NetworkHealth_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ground_station::NetworkHealth_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ground_station::NetworkHealth_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ground_station::NetworkHealth_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ground_station::NetworkHealth_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ground_station::NetworkHealth_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ground_station::NetworkHealth_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ground_station::NetworkHealth_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xac2c11ce338d0f15ULL;
  static const uint64_t static_value2 = 0x8d26170ccf720443ULL;
};

template<class ContainerAllocator>
struct DataType< ::ground_station::NetworkHealth_<ContainerAllocator> >
{
  static const char* value()
  {
    return "ground_station/NetworkHealth";
  }
...
template<class ContainerAllocator>
struct Definition< ::ground_station::NetworkHealth_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ground_station::NetworkHealth_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ground_station::NetworkHealth_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ground_station::NetworkHealth_<ContainerAllocator>& v)
  {
...
#endif // GROUND_STATION_MESSAGE_NETWORKHEALTH_H
